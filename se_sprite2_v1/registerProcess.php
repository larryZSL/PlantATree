<?php
    ...
    if($psw == $re_password) {
        ...
        if($userID == $row['cus_id']) 
        {
            ...
            $sql_insert = "INSERT INTO customer (cus_id,cus_password,cus_fname,cus_lname,cus_gender,cus_email,cus_phone,cus_address) VALUES('$userID','$psw','$fname','$lname','$gender','$email','$phone','$address')";
